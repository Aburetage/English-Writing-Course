/* ===== English Writing Course — Site-Wide Engine ===== */
...
/* ===== إضافة شريط التنقل ديناميكيًا إذا لم يكن موجودًا ===== */
...
/* ===== إضافة شريط التبويبات السفلي ديناميكيًا إذا لم يكن موجودًا ===== */
...
(function(){
  ...
  $$('.bb-tab').forEach(t=>{
    t.addEventListener('click',e=>{
      ...
      if(k==='toc'){e.preventDefault();if(toc){toc.classList.add('open');const b=$('#backdrop');if(b)b.classList.add('show');}return;}
