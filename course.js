/* ===== English Writing Course — Site-Wide Engine (Single-Page Lessons) ===== */
...
/* ===== الفهرس ===== */
const toc = $('#toc');
const closeToc = () => { toc.classList.remove('open'); const b = $('#backdrop'); if (b) b.classList.remove('show'); };
const mb = $('#menuBtn');
if (mb) mb.onclick = () => { toc.classList.toggle('open'); const b = $('#backdrop'); if (b) b.classList.toggle('show'); };
const bd = $('#backdrop');
...
/* ===== سحب الموبايل: للتنقل بين الدروس (ليس المحاور) ===== */
(function () {
